                ...
                foreach ($query as $query) {
                    ...
                    <div class="listing-container">
                        <div class="listing-image-container">
                            ...
                            <form action="<?php echo URL; ?>favorites/deleteFavorite" method="POST">
                        ...
                        <div class="listing-preview">
                            ...
                            <?php if (!empty($_SESSION)) { ?>
                                ...
                                <div class="form-group">
                                    <a href="<?php echo URL; ?>/index#message?rental_unit_id=<?php echo $rental_unit_id ?>,lister_id=<?php echo $lister_id ?>" onclick="document.getElementById('popup-message').style.display = 'block'"><button class="listing-message-btn">Message Lister</button></a>
                                </div>
                            <?php } ?>                
                        </div>
                    </div>
