...
foreach ($query as $query) {
    ...
    <div class="crop">
        ...
        if (isset($query->thumbnail)) {
            ...
            . "' alt='Item image' class='details-image'>";
        }
        if (!isset($query->thumbnail)) {
            echo "<img src='" . URL . "img/default-thumbnail.jpg' title='default' width='330' height='230' class='thumbnail' class='details-image'>";
        }
        ?>       
    </div>
    <div class="container" id="details">
            <div class="col-lg-8">
                <h3><?php if (isset($query->title)) echo htmlspecialchars($query->title, ENT_QUOTES, 'UTF-8'); ?></h3>
            ...
            <div class="col-lg-4">
                <h3>$<?php if (isset($query->rent)) echo htmlspecialchars($query->rent, ENT_QUOTES, 'UTF-8'); ?> / month</h3>
