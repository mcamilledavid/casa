...
class Model {
    ...
    public function addNewRentalUnit($listerId,$title,$street,$city,$state,$zipcode,
        ...
        $sql = "INSERT INTO rental_unit (lister_id,title, street,city,state,zipcode,beds,baths,rent,deposit,"
            ."date_availability,lease_length,description,pets,smoking,furnished,parking,laundry,type,dist_from_campus,is_rented)"
                . "VALUES (:listerId,:title,:street,:city,:state,:zipcode,:beds,:baths,:rent,:deposit,"
            .":date_availability,:lease_length,:description,:pets,:smoking,:furnished,:parking,:laundry,:type,:distance_from_campus,:is_rented)";
        $query = $this->db->prepare($sql);
